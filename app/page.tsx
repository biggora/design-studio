        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              <Image src="/placeholder.svg" alt="Print 1" width={400} height={300} className="w-full" />
              <div className="p-4">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              <Image src="/placeholder.svg" alt="Print 2" width={400} height={300} className="w-full" />
              <div className="p-4">
                <h3 className="font-semibold mb-2 text-[#212A31]">Print Title</h3>
                <p className="text-[#748D92]">Short print description</p>
              </div>
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              <Image src="/placeholder.svg" alt="Print 3" width={400} height={300} className="w-full" />
              <div className="p-4">
                <h3 className="font-semibold mb-2 text-[#212A31]">Print Title</h3>
                <p className="text-[#748D92]">Short print description</p>
              </div>
