  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="ThreadQuirk is a cutting-edge design studio specializing in unique and quirky thread-based designs."
        />
        <meta
          name="keywords"
          content="thread art, textile design, innovative design, bespoke creations"
        />
      </Helmet>
