    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content={`Discover the unique ${print.title} print by ThreadQuirk. ${print.description}`} />
                <meta name="keywords" content={`${print.keywords}, thread art, textile design, ThreadQuirk print`} />
            </Helmet>

            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <Link href="/prints" className="text-[#124E66] hover:underline mb-4 inline-block">
                    &larr; Back to Prints
                </Link>
                <div className="bg-white shadow-md rounded-lg overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="p-6">
                            <h1 className="text-3xl font-bold mb-4 text-[#212A31]">{print.title}</h1>
                            <p className="text-[#748D92] mb-6">{print.description}</p>
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                <div>
                                    <h2 className="text-xl font-semibold mb-2 text-[#212A31]">Dimensions</h2>
                                    <p className="text-[#748D92]">{print.dimensions}</p>
                                </div>
                                <div>
                                    <h2 className="text-xl font-semibold mb-2 text-[#212A31]">Material</h2>
                                    <p className="text-[#748D92]">{print.material}</p>
                                </div>
                                <div>
                                    <h2 className="text-xl font-semibold mb-2 text-[#212A31]">Price</h2>
                                    <p className="text-[#748D92]">${print.price}</p>
                                </div>
                                <div>
                                    <h2 className="text-xl font-semibold mb-2 text-[#212A31]">Availability</h2>
