  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Learn about ThreadQuirk's journey, our passionate team, and our innovative approach to thread-based design." />
        <meta name="keywords" content="ThreadQuirk, about us, design studio, thread art, textile innovation" />
      </Helmet>

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-4xl font-bold mb-8 text-[#212A31]">About ThreadQuirk</h1>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <Image alt="Team Member" src={NoImagesAvailable} className="w-48 h-48 rounded-full mx-auto mb-4" />
        ...
        <section>
          ...
          <p className="text-gray-700">
            This approach allows us to create prints that are not only visually striking but also meaningful and impactful.
          </p>
        </section>
      </div>
    </>
