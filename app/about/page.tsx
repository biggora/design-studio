    ...
    <div className="container mx-auto px-6 py-12">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-700">
          ...
          to pushing the boundaries of design remains at the core of everything
          we do.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700 mb-4">
          ...
          blend of creativity, technical skill, and a deep understanding of our
          clients&apos; needs. Our approach is rooted in:
        </p>
