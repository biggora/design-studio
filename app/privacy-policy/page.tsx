    ...
    <div className="container mx-auto px-6 py-12">
      ...
      <div className="prose prose-lg max-w-none text-[#212A31]">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>Technical Data: IP address, browser type and version, time zone setting, browser plug-in types and versions, operating system and platform, and other technology on the devices you use to access this website.</li>
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>Direct Interactions: When you provide it to us by filling in forms or corresponding with us by post, phone, email, or otherwise.</li>
          <li>Automated Technologies: As you interact with our website, we may automatically collect Technical Data about your equipment, browsing actions, and patterns. We collect this data using cookies, server logs, and other similar technologies.</li>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">4. Use of Your Information</h2>
